  ...
  onDeleteStream(invokeMessage) {
    ...
    if (invokeMessage.streamId == this.publishStreamId) {
      if (this.isPublishing) {
		...
		var tempStreamId = this.publishStreamPath;
      ...
      this.publishStreamId = 0;
      this.publishStreamPath = '';
	  console.log("THIS IS THE VALUD YOU ARE LOOKING FOR " + tempStreamId)
      context.nodeEvent.emit('donePublish', this.id, tempStreamId, this.publishArgs);
    }
